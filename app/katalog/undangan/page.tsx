    ...
    katalogAktif === "Buku Yasin"
      ...
      : seriAktif === "Semua"
        ...
        : semuaFotoUndangan.filter(
            (foto) =>
              foto.seriId === seriGallery[seriAktif]
          );
      ...
      <section className="mx-auto max-w-7xl px-6 py-12">
        ...
        <div className="mb-12 text-center">
          <h1 className="text-4xl font-bold text-slate-900">
            {katalogAktif === "Buku Yasin"
              ? "Katalog Buku Yasin"
              : "Katalog Undangan Pernikahan"}
          </h1>

          <p className="mt-4 text-lg text-slate-600">
            {katalogAktif === "Buku Yasin"
              ? "Koleksi Buku Yasin Mell Studio dengan berbagai pilihan desain dan finishing."
              : "Koleksi undangan Mell Studio dengan berbagai seri dan finishing premium."}
          </p>
        </div>
